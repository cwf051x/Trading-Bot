...
class Settings(BaseSettings):
    ...
    alert_auto_paper_trading_enabled: bool = Field(default=True, alias="ALERT_AUTO_PAPER_TRADING_ENABLED")
    ...
    alert_rule_hourly_trend_enabled: bool = Field(default=True, alias="ALERT_RULE_HOURLY_TREND_ENABLED")
    alert_hourly_t1_price_change_6h: float = Field(default=0.08, alias="ALERT_HOURLY_T1_PRICE_CHANGE_6H")
    alert_hourly_t1_ma7_ma25_min_ratio: float = Field(default=0.995, alias="ALERT_HOURLY_T1_MA7_MA25_MIN_RATIO")
    alert_hourly_t1_volume_multiplier: float = Field(default=1.5, alias="ALERT_HOURLY_T1_VOLUME_MULTIPLIER")
    alert_hourly_t1_oi_change_6h: float = Field(default=0.08, alias="ALERT_HOURLY_T1_OI_CHANGE_6H")
    alert_hourly_t2_price_change_12h: float = Field(default=0.20, alias="ALERT_HOURLY_T2_PRICE_CHANGE_12H")
    alert_hourly_t2_bullish_count_12: int = Field(default=8, alias="ALERT_HOURLY_T2_BULLISH_COUNT_12")
    alert_hourly_t2_oi_change_12h: float = Field(default=0.15, alias="ALERT_HOURLY_T2_OI_CHANGE_12H")
    alert_hourly_t2_volume_expansion: float = Field(default=1.5, alias="ALERT_HOURLY_T2_VOLUME_EXPANSION")
    alert_hourly_t3_price_change_12h: float = Field(default=0.15, alias="ALERT_HOURLY_T3_PRICE_CHANGE_12H")
    alert_hourly_t3_oi_change_12h: float = Field(default=0.10, alias="ALERT_HOURLY_T3_OI_CHANGE_12H")
    alert_hourly_t3_pullback_min: float = Field(default=0.04, alias="ALERT_HOURLY_T3_PULLBACK_MIN")
    alert_hourly_t3_pullback_max: float = Field(default=0.10, alias="ALERT_HOURLY_T3_PULLBACK_MAX")
    alert_hourly_t3_oi_pullback_max: float = Field(default=0.10, alias="ALERT_HOURLY_T3_OI_PULLBACK_MAX")
    alert_hourly_t4_price_change_24h: float = Field(default=0.50, alias="ALERT_HOURLY_T4_PRICE_CHANGE_24H")
    alert_hourly_t4_ma25_deviation: float = Field(default=0.20, alias="ALERT_HOURLY_T4_MA25_DEVIATION")
    alert_hourly_t4_rsi6: float = Field(default=85.0, alias="ALERT_HOURLY_T4_RSI6")
    alert_hourly_t4_rsi24: float = Field(default=75.0, alias="ALERT_HOURLY_T4_RSI24")
    alert_hourly_t4_oi_change_24h: float = Field(default=0.40, alias="ALERT_HOURLY_T4_OI_CHANGE_24H")
