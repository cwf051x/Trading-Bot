...
class Settings(BaseSettings):
    ...
    risk_max_open_positions: int = Field(default=10, alias="RISK_MAX_OPEN_POSITIONS")
    risk_max_symbol_position_pct: float = Field(default=0.05, alias="RISK_MAX_SYMBOL_POSITION_PCT")
    ...
    minute_runner_enabled: bool = Field(default=True, alias="MINUTE_RUNNER_ENABLED")
    minute_runner_telegram_enabled: bool = Field(default=True, alias="MINUTE_RUNNER_TELEGRAM_ENABLED")
    minute_runner_digest_interval_seconds: int = Field(default=300, alias="MINUTE_RUNNER_DIGEST_INTERVAL_SECONDS")
    minute_runner_digest_no_change_interval_seconds: int = Field(default=900, alias="MINUTE_RUNNER_DIGEST_NO_CHANGE_INTERVAL_SECONDS")
    minute_runner_digest_top_n: int = Field(default=8, alias="MINUTE_RUNNER_DIGEST_TOP_N")
    minute_runner_min_score_to_show: int = Field(default=72, alias="MINUTE_RUNNER_MIN_SCORE_TO_SHOW")
    minute_runner_email_enabled: bool = Field(default=False, alias="MINUTE_RUNNER_EMAIL_ENABLED")
    minute_runner_email_to: str = Field(default="", alias="MINUTE_RUNNER_EMAIL_TO")
    minute_runner_email_from: str = Field(default="", alias="MINUTE_RUNNER_EMAIL_FROM")
    minute_runner_email_provider: str = Field(default="qq_agent", alias="MINUTE_RUNNER_EMAIL_PROVIDER")
    minute_runner_email_global_cooldown_seconds: int = Field(default=1800, alias="MINUTE_RUNNER_EMAIL_GLOBAL_COOLDOWN_SECONDS")
    minute_runner_email_max_per_hour: int = Field(default=2, alias="MINUTE_RUNNER_EMAIL_MAX_PER_HOUR")
    minute_runner_email_min_score: int = Field(default=88, alias="MINUTE_RUNNER_EMAIL_MIN_SCORE")
    minute_runner_email_top_rank: int = Field(default=5, alias="MINUTE_RUNNER_EMAIL_TOP_RANK")
